const { createPosts, getAllForums, 
    ...
    getPosts, getForums, createGroup, getForumPosts, createMarketPosts, 
    getMarketplace} = require("./handlers");
...
app.post('marketplace', FBAuth, createMarketPosts);

// Get Marketplace
app.get('marketplace', getMarketplace);
